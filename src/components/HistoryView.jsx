...
const DRIVER_CAREER_STATS = {
  "max_verstappen": { starts: 233, wins: 71, podiums: 127, poles: 51, points: 3444.5, titles: 4, fastestLaps: 36, teams: ["Toro Rosso", "Red Bull"] },
  ...
  "norris": { starts: 150, wins: 11, podiums: 44, poles: 16, points: 1430.0, titles: 1, fastestLaps: 18, teams: ["McLaren"] },
  "piastri": { starts: 68, wins: 9, podiums: 26, poles: 6, points: 799.0, titles: 0, fastestLaps: 9, teams: ["McLaren"] },
  ...
  "perez": { starts: 282, wins: 6, podiums: 39, poles: 3, points: 1638.0, titles: 0, fastestLaps: 12, teams: ["Sauber", "McLaren", "Force India", "Racing Point", "Red Bull", "Cadillac F1 Team"] },
  "alonso": { starts: 426, wins: 32, podiums: 106, poles: 23, points: 2393.0, titles: 2, fastestLaps: 25, teams: ["Minardi", "Renault", "McLaren", "Ferrari", "Alpine F1 Team", "Aston Martin"] },
  "albon": { starts: 127, wins: 0, podiums: 2, poles: 0, points: 313.0, titles: 0, fastestLaps: 1, teams: ["Toro Rosso", "Red Bull", "Williams"] },
  "tsunoda": { starts: 113, wins: 0, podiums: 0, poles: 0, points: 124.0, titles: 0, fastestLaps: 1, teams: ["AlphaTauri", "RB F1 Team", "Red Bull"] },
  "bottas": { starts: 246, wins: 10, podiums: 67, poles: 19, points: 1797.0, titles: 0, fastestLaps: 19, teams: ["Williams", "Mercedes", "Alfa Romeo", "Sauber", "Cadillac F1 Team"] },
  "hulkenberg": { starts: 252, wins: 0, podiums: 1, poles: 1, points: 622.0, titles: 0, fastestLaps: 2, teams: ["Williams", "Force India", "Sauber", "Renault", "Racing Point", "Aston Martin", "Haas F1 Team", "Audi"] },
  "ocon": { starts: 180, wins: 1, podiums: 4, poles: 0, points: 483.0, titles: 0, fastestLaps: 1, teams: ["Manor Marussia", "Force India", "Renault", "Alpine F1 Team", "Haas F1 Team"] },
  "gasly": { starts: 177, wins: 1, podiums: 5, poles: 0, points: 458.0, titles: 0, fastestLaps: 3, teams: ["Toro Rosso", "Red Bull", "AlphaTauri", "Alpine F1 Team"] },
  "stroll": { starts: 189, wins: 0, podiums: 3, poles: 1, points: 325.0, titles: 0, fastestLaps: 0, teams: ["Williams", "Racing Point", "Aston Martin"] },
  "kevin_magnussen": { starts: 184, wins: 0, podiums: 1, poles: 1, points: 202.0, titles: 0, fastestLaps: 3, teams: ["McLaren", "Renault", "Haas F1 Team"] },
  "ricciardo": { starts: 257, wins: 8, podiums: 32, poles: 3, points: 1329.0, titles: 0, fastestLaps: 17, teams: ["HRT", "Toro Rosso", "Red Bull", "Renault", "McLaren", "AlphaTauri", "RB F1 Team"] },
  "colapinto": { starts: 26, wins: 0, podiums: 0, poles: 0, points: 5.0, titles: 0, fastestLaps: 0, teams: ["Williams", "Alpine F1 Team"] },
  "lawson": { starts: 35, wins: 0, podiums: 0, poles: 0, points: 44.0, titles: 0, fastestLaps: 0, teams: ["AlphaTauri", "RB F1 Team", "Red Bull"] },
  "bortoleto": { starts: 23, wins: 0, podiums: 0, poles: 0, points: 19.0, titles: 0, fastestLaps: 0, teams: ["Sauber", "Audi"] },
  "antonelli": { starts: 24, wins: 0, podiums: 3, poles: 0, points: 150.0, titles: 1, fastestLaps: 3, teams: ["Mercedes"] },
  "bearman": { starts: 27, wins: 0, podiums: 0, poles: 0, points: 48.0, titles: 0, fastestLaps: 0, teams: ["Ferrari", "Haas F1 Team"] },
  "doohan": { starts: 7, wins: 0, podiums: 0, poles: 0, points: 0.0, titles: 0, fastestLaps: 0, teams: ["Alpine F1 Team"] },
  "hadjar": { starts: 24, wins: 0, podiums: 1, poles: 0, points: 51.0, titles: 0, fastestLaps: 0, teams: ["RB F1 Team", "Red Bull"] }
};
